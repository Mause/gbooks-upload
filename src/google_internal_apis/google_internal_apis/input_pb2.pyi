...
class Tagged(_message.Message):
    ...
    def __init__(
        self,
        book_id: _Optional[str] = ...,
        tag_id: _Optional[str] = ...,
        tagged_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
    ) -> None: ...
...
class TagsResponse(_message.Message):
    ...
    def __init__(
        ...
        tagged_items: _Optional[_Iterable[_Union[Tagged, _Mapping]]] = ...,
    ) -> None: ...
...
class TagRequest(_message.Message):
    ...
    tagged_items: _containers.RepeatedCompositeFieldContainer[Tagged]
    def __init__(
        self, tagged_items: _Optional[_Iterable[_Union[Tagged, _Mapping]]] = ...
    ) -> None: ...
...
class LibraryDocumentResponse(_message.Message):
    ...
    def __init__(
        self, library_documents: _Optional[_Union[LibraryDocument, _Mapping]] = ...
    ) -> None: ...
...
class LibraryDocument(_message.Message):
    ...
    class Book(_message.Message):
        ...
        class BookGenre(_message.Message):
            ...
            def __init__(
                self,
                genre: _Optional[_Union[LibraryDocument.Book.Genre, _Mapping]] = ...,
            ) -> None: ...
        ...
        class Geo(_message.Message):
            ...
            geo_id: str
            def __init__(
                self, geo: _Optional[str] = ..., geo_id: _Optional[str] = ...
            ) -> None: ...
        ...
        class Genre(_message.Message):
            ...
            subgenre: str
            def __init__(
                self, genre: _Optional[str] = ..., subgenre: _Optional[str] = ...
            ) -> None: ...
        ...
        class Rating(_message.Message):
            ...
            def __init__(
                ...
                number_of_reviews: _Optional[str] = ...,
            ) -> None: ...
        ...
        class Series(_message.Message):
            ...
            series: _containers.RepeatedCompositeFieldContainer[
                LibraryDocument.Book.SingleSeries
            ]
            book_in_series: str
            def __init__(
                self,
                this_book_title: _Optional[str] = ...,
                series: _Optional[
                    _Iterable[_Union[LibraryDocument.Book.SingleSeries, _Mapping]]
                ] = ...,
                book_in_series: _Optional[str] = ...,
            ) -> None: ...
        ...
        class SingleSeries(_message.Message):
            ...
            def __init__(
                self,
                series_id: _Optional[str] = ...,
                unknown1: _Optional[int] = ...,
                unknown2: _Optional[int] = ...,
                unknown3: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...,
                unknown4: _Optional[int] = ...,
        ...
        page_count: int
        version: str
        cover_images: _containers.RepeatedCompositeFieldContainer[
            LibraryDocument.Book.CoverImage
        ]
        language: str
        url: str
        unknown1: int
        ...
        genres: _containers.RepeatedCompositeFieldContainer[
            LibraryDocument.Book.BookGenre
        ]
        def __init__(
            self,
            title: _Optional[str] = ...,
            ...
            published_date: _Optional[_Union[_date_pb2.Date, _Mapping]] = ...,
            description: _Optional[str] = ...,
            page_count: _Optional[int] = ...,
            version: _Optional[str] = ...,
            cover_images: _Optional[
                _Iterable[_Union[LibraryDocument.Book.CoverImage, _Mapping]]
            ] = ...,
            language: _Optional[str] = ...,
            url: _Optional[str] = ...,
            unknown1: _Optional[int] = ...,
            unknown2s: _Optional[_Iterable[int]] = ...,
            unknown3: _Optional[int] = ...,
            unknown4: _Optional[int] = ...,
            series: _Optional[_Union[LibraryDocument.Book.Series, _Mapping]] = ...,
            unknown5s: _Optional[_Iterable[int]] = ...,
            unknown6: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...,
            geos: _Optional[
                _Iterable[_Union[LibraryDocument.Book.Geo, _Mapping]]
            ] = ...,
            unknown7: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...,
            rating: _Optional[_Union[LibraryDocument.Book.Rating, _Mapping]] = ...,
            genres: _Optional[
                _Iterable[_Union[LibraryDocument.Book.BookGenre, _Mapping]]
            ] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        book_id: _Optional[str] = ...,
        book: _Optional[_Union[LibraryDocument.Book, _Mapping]] = ...,
    ) -> None: ...
