...
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE = _PLAYERSEARCHRESULTSPROTO.nested_types_by_name[
    "field1_type"
]
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS = (
    _PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE.nested_types_by_name["Results"]
)
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE = (
    _PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS.nested_types_by_name["field1_type"]
)
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE = (
    _PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE.nested_types_by_name[
        "field1_type"
    ]
)
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE_PLAYER = _PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE.nested_types_by_name[
    "Player"
]
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE_PLAYER_AVATAR = _PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE_PLAYER.nested_types_by_name[
    "Avatar"
]
_PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE_PLAYER_ACCOUNT = _PLAYERSEARCHRESULTSPROTO_FIELD1_TYPE_RESULTS_FIELD1_TYPE_FIELD1_TYPE_PLAYER.nested_types_by_name[
    "Account"
]
PlayerSearchResultsProto = _reflection.GeneratedProtocolMessageType(
...
_sym_db.RegisterMessage(
    PlayerSearchResultsProto.field1_type.Results.field1_type.field1_type
)
_sym_db.RegisterMessage(
    PlayerSearchResultsProto.field1_type.Results.field1_type.field1_type.Player
)
_sym_db.RegisterMessage(
    PlayerSearchResultsProto.field1_type.Results.field1_type.field1_type.Player.Avatar
)
_sym_db.RegisterMessage(
    PlayerSearchResultsProto.field1_type.Results.field1_type.field1_type.Player.Account
)
