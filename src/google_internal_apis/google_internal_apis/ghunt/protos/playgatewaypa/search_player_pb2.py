...
_PLAYERSEARCHPROTO_SEARCHFORM_QUERY = (
    _PLAYERSEARCHPROTO_SEARCHFORM.nested_types_by_name["Query"]
)
PlayerSearchProto = _reflection.GeneratedProtocolMessageType(
    "PlayerSearchProto",
    (_message.Message,),
    {
        "SearchForm": _reflection.GeneratedProtocolMessageType(
            "SearchForm",
            (_message.Message,),
            {
